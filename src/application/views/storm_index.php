...
<head>
    <title>Storm Site</title>
    <meta http-equiv="Content-Type" content="text/html; charset=windows-1250" />
    <link rel="stylesheet" type="text/css" media="screen, projection" href="/themes/storm/template/menu.css" />
    <link rel="stylesheet" type="text/css" media="screen, projection" href="/themes/storm/template/style.css" />
    <style type="text/css">
        <!--

        div.wrap1 .wrap2 {
            /* only with left panel- background-image: url(/themes/storm/template/bg1.gif); */
            /* right and left panel */ /*background-image: url(/themes/storm/template/img/bg2.gif);
            /* only with right panel - background-image: url(/themes/storm/template/bg3.gif); */
        }
...
<div class="wrap1">
    <div class="wrap2">
        <div class="logo">
            <div style="display:inline; float:left;"> Corporation ltd.
                <div class="slogan">Free CSS Website Template</div>
            </div>
        ...
        <div id="menu">
            ...
            <div class="info"> This text is describing selected item. You may give here advertisement, informations etc. Whatever! </div>
            <div class="leftpanel">
                ...
                <div class="text"> <strong>Corporation ltd.</strong><br />
                    <br />
                    212 Military Parkway<br />
                    <span class="divider">Los Angeles, CA 94043</span> Telephone: +421 903 000 000<br />
                    E-mail: e-mail@domain.com<br />
                    ICQ: 000-000-000<br />
                    Skype: corporation1<br />
                    <br />
                </div>
            </div>
            <div class="mainpanel">
            ...
            <div class="rightpanel">
                ...
                <div class="inquiry"> <span class="divider" style="font-weight:bold;">Pri iudico cetero euripidis eu, tota utinam interesset nam et?</span> <span class="divider"><a href="#">Viris delectus voluptatum</a> (467)</span> <span class="divider"><a href="#">Has ne etiam epicuri</a> (1347)</span> <span class="divider"><a href="#">Docendi honestatis eos ne</a> (608)</span> <span class="divider"><a href="#">Mel ex ullum probatus similique</a> (609)</span> <strong>3031 votes</strong><br />
                    <br />
                </div>
                ...
                <div class="text"> <strong>Corporation ltd.</strong><br />
                    ...
                    E-mail: e-mail@domain.com<br />
                    ICQ: 000-000-000<br />
                    <span class="divider">Skype: corporation1</span> Telephone: +421 903 000 000<br />
                    E-mail: e-mail@domain.com<br />
                    ICQ: 000-000-000<br />
                    Skype: corporation1<br />
                    <br />
        ...
        <div class="info1">
            <div style="display:inline; float:left;">&copy; 2008 <a href="#">yourwebsite.com</a>. Design <a href="http://pbcreations.sk">P&amp;B Creations</a>.</div>
            <div style="display:inline; float:right;"><a href="http://www.topas-tachlovice.cz/topas-tachlovice.aspx">Tachlovice</a></div>
        </div>
    </div>
</div>
</body>
