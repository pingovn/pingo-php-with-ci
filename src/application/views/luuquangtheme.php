...
<html>
	<head>
		...
		<script src="/themes/luuquang/js/jquery.min.js"></script>
				...
				<div class="row">
					<div class="12u">
						...
						<header id="header">
							...
							<nav id="nav">
								<a href="/themes/luuquang/index.html">Homepage</a>
								<a href="/themes/luuquang/twocolumn1.html">Two Column #1</a>
								<a href="/themes/luuquang/twocolumn2.html" class="current-page-item">Two Column #2</a>
								<a href="/themes/luuquang/onecolumn.html">One Column</a>
								<a href="/themes/luuquang/threecolumn.html">Three Column</a>
							</nav>
						</header>
					...
					<div class="4u">
						...
						<section>
							...
							<ul class="small-image-list">
								<li>
									<a href="#"><img src="/themes/luuquang/images/pic2.jpg" alt="" class="left" /></a>
									<h4>Jane Anderson</h4>
									<p>Varius nibh. Suspendisse vitae magna eget et amet mollis justo facilisis amet quis.</p>
								</li>
								<li>
									<a href="#"><img src="/themes/luuquang/images/pic1.jpg" alt="" class="left" /></a>
									<h4>James Doe</h4>
