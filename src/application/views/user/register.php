...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/themes/phatnguyen/reg_form/css/demo.css" />
        <link rel="stylesheet" type="text/css" href="/themes/phatnguyen/reg_form/css/style.css" />
		<link rel="stylesheet" type="text/css" href="/themes/phatnguyen/reg_form/css/animate-custom.css" />
    </head>
    <body>
        <div class="container">
            <!-- Codrops top bar -->
